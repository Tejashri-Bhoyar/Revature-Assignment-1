...
class DelegatesDemoApp
{
    ...
    public void Run()
    {
        ...
        Func<int, int, int> genericOperation = Add; //function delegates

        Action<string> action = PrintMessage;
        action("Hello from Action delegate!"); //action delegates

        Predicate<int> predicate = IsEven;  //predicate delegates
        int testNumber = 4;
